...
const BoxScore: FC<BoxScoreProps> = ({boxscore ,teamLogos}) => {
    ...
    <div className="overflow-auto lg:mx-80 lg:py-8 lg:border-2 lg:border-gray-100 lg:rounded-2xl lg:my-4">
        <div>
                    ...
                    <tbody>
                        {selectTeamBoxScore.players.map((player) => (
                            <tr key={player.personId} className="even:bg-slate-100 odd:bg-white">
                                <td className="px-2 py-2 sticky left-0 bg-white border-r-2 border-gray-100 lg:bg-transparent lg:w-80">
